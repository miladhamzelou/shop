...
DataTable.ext.buttons.excelHtml5 = {
	...
	action: function ( e, dt, button, config ) {
		...
		zip.file(           '%5bContent_Types%5d.html', excelStrings['[Content_Types].xml'] );
		_rels.file(         '.rels',               excelStrings['_rels/.rels'] );
		xl.file(            'workbook.html',        excelStrings['xl/workbook.xml'].replace( '__SHEET_NAME__', _sheetname( config ) ) );
		xl_rels.file(       'workbook.xml.rels',   excelStrings['xl/_rels/workbook.xml.rels'] );
		xl_worksheets.file( 'sheet1.html',          excelStrings['xl/worksheets/sheet1.xml'].replace( '__DATA__', xml ) );
...
DataTable.ext.buttons.pdfHtml5 = {
	...
	text: function ( dt ) {
		return dt.i18n( 'buttons-2.html', 'PDF' );
	},
